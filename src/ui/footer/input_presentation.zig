...
pub const PickerKind = enum { model_stage, provider_stage, models, file, slash, skills, help, settings, sessions, mcp, definition_manager, auth };
...
pub fn measureRawInputGeometryPreparedWithProvider(
    ...
    const picker_start_col = if (!show_model_query and (show_provider_query or show_file_query or show_slash_query))
